...
SECRET_KEY = "django-insecure-iyh6f-!+ya#c%^bfxy7@kysgc9t627fnp$0lmq#)t)1e9zfioo"
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_REFRESH_SLIDING_LIFETIME': timedelta(days=1),

    'SLIDING_TOKEN_REFRESH_SLIDING_LIFETIME_GRACE_PERIOD': timedelta(days=1),
